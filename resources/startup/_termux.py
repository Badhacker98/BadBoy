...
COPYRIGHT = f"©️ PBX_PERMOT {datetime.now().year}"
...
3. Some of the plugins are disabled for 'Termux Users' to save resources (by adding in EXCLUDE_OFFICIAL).
   - Read More - https://t.me/BadBoyUpdates/36
...
█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█ █▄▄▄█ █▄▄▄█  █▄█▄▄▄▄▄▄▄█▄▄▄█▄▄▄▄▄▄█ 
{Style.RESET_ALL}
{Fore.GREEN}- BadBoy Termux Installation -
  The Main Aim of this script is to deploy BadBoy with basic requirements and save your phone resources.
{Fore.RESET}
...
print(f"{Fore.YELLOW}* Do you want to get BadBoy Logs in Colors? [Y/N] ")
...
sleep(0.2)
print(f"Use 'bash startup' to try running BadBoy.{Fore.RESET}")
sleep(0.5)
print(
    "\nYou can head over to , if you get stuck somewhere, and need help."
)
sleep(0.5)
print("\nMade with ❤️ by @PBX_PERMOT...")
