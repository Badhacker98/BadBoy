...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to BadBoy, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf BadBoy")
    os.system("git clone https://github.com/Badhacker98/BadBoy")
    print("\n\nDone")
    os.chdir("BadBoy")
    clear_screen()
    print(a)
    ...
    all_done = "# BadBoy Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
