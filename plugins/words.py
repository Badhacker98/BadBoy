...
from BadBoy.fns.misc import get_synonyms_or_antonyms
from BadBoy.fns.tools import async_searcher

from . import get_string, BadBoy_cmd


@BadBoy_cmd(pattern="meaning( (.*)|$)", manager=True)
