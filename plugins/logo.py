...
try:
    ...
    Image = None
from BadBoy.fns.misc import unsplashsearch
from BadBoy.fns.tools import LogoHelper

from . import OWNER_ID, OWNER_NAME, download_file, get_string, mediainfo, BadBoy_cmd


@BadBoy_cmd(pattern="logo( (.*)|$)")
