...
from BadBoy.dB.echo_db import add_echo, check_echo, list_echo, rem_echo

from . import inline_mention, BadBoy_cmd


@BadBoy_cmd(pattern="addecho( (.*)|$)")
async def echo(e):
