...
from BadBoy._misc._assistant import callback, in_pattern
from BadBoy.dB._core import HELP, LIST
from BadBoy.fns.helper import gen_chlog, time_formatter, updater
from BadBoy.fns.misc import split_list
...
from Plugin._help import _main_help_menu
...
SUP_BUTTONS = [
    [
        ...
        Button.url("• Support •", url="https://t.me/PBX_CHAT"),
    ],
]
...
async def inline_alive(o):
    TLINK = inline_pic() or "https://telegra.ph/file/312778d594ebfda4ae8d4.jpg"
    MSG = "• **BadBoy Userbot •**"
    WEB0 = InputWebDocument(
        "https://telegra.ph/file/ca0108c1deff836b09085.jpg", 0, "image/jpg", []
    )
    RES = [
...
async def inline_handler(event):
    ...
    if inline_pic():
        ...
        result = await event.builder.article(
            title="BadBoy Help Menu", text=text, buttons=_main_help_menu
        )
...
async def ibuild(e):
    ...
    if pic:
        try:
            ...
            LOGS.exception(er)
    result = [
        await builder.article("BadBoy Op", text=txt, link_preview=False, buttons=btn)
    ]
