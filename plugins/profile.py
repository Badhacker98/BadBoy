...
from . import eod, eor, get_string, mediainfo, BadBoy_cmd
...
@BadBoy_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@BadBoy_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@BadBoy_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@BadBoy_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)
