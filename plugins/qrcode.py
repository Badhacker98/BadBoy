...
from . import check_filename, get_string, BadBoy_bot, BadBoy_cmd


@BadBoy_cmd(pattern="qrcode( (.*)|$)")
async def cd(e):
    ...
    elif BadBoy_bot.me.photo and not BadBoy_bot.me.photo.has_video:
        cimg = (await e.client.get_profile_photos(BadBoy_bot.uid, limit=1))[0]
