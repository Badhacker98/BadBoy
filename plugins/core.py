...
from BadBoy.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, BadBoy_cmd, un_plug


@BadBoy_cmd(pattern="install", fullsudo=True)
...
@BadBoy_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
