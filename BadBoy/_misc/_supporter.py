...
from BadBoy._misc._decorators import compile_pattern, BadBoy_cmd
...
ALIVE_NAME = BadBoy_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = BadBoy_bot
catub.cat_cmd = BadBoy_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "BadBoy")
